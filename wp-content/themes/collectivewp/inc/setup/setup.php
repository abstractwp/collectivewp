...
function setup() {
	 ...
	 * references of wd_s
	 */
	load_theme_textdomain( 'collectivewp', get_template_directory() . '/build/languages' );
	...
	register_nav_menus(
		[
			'primary' => esc_html__( 'Primary Menu', 'collectivewp' ),
			'footer'  => esc_html__( 'Footer Menu', 'collectivewp' ),
			'mobile'  => esc_html__( 'Mobile Menu', 'collectivewp' ),
		]
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'collectivewp_custom_background_args',
			[
	...
	add_theme_support(
		...
		[
			[
				'name' => __( 'Small', 'collectivewp' ),
				'size' => 12,
				'slug' => 'small',
			],
			[
				'name' => __( 'Normal', 'collectivewp' ),
				'size' => 16,
				'slug' => 'normal',
			],
			[
				'name' => __( 'Large', 'collectivewp' ),
				'size' => 36,
				'slug' => 'large',
			],
			[
				'name' => __( 'Huge', 'collectivewp' ),
				'size' => 50,
				'slug' => 'huge',
			],
		]
