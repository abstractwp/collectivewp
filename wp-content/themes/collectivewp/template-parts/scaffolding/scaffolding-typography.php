...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'typography', 'collectivewp' ); ?>">
		<?php esc_html_e( 'Typography', 'collectivewp' ); ?></h2>
	...
	print_scaffolding_section(
		[
			...
			'usage'       => '<del>CollectiveWP</del>',
			'output'      => '<p>We use <del>CollectiveWP</del> wd_s to build themes.</p>',
		]
	);
